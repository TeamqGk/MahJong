...
function hero:init()
  ...
  self.vision.left = self.angle - (self.vision.left * 0.5)
  self.vision.right = self.angle + (self.vision.left * 0.5)
...
function Scene25D.load() -- love.load()
  hero:init()
  map:init()
end
--

function Scene25D.update(dt) -- love.updadte(dt)
end
--

function Scene25D.draw()-- love.draw()-- love.draw()
  hero:camDraw()
end
--

function Scene25D.keypressed(key, scancode, isrepeat) -- love.keypressesed()
  if key == "escape" then
